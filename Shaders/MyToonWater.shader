//Made from https://roystan.net/articles/toon-water.html
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f
            {
				...
				float3 normalInWorldCoords : viewNormal;
				float3 vertexInWorldCoords : distortUV;
            };
			...
			float4 _DepthGradientDeep; //change to be the color of the CUBE MAP
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				return float4(lerp(reflectColor, alphaBlend(surfaceNoiseColor, waterColor),_Mix).rgb, 1.0);
            }
            ENDCG
        }
    }
